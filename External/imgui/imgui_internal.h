...
struct ImPool
{
    ...
    void        Reserve(int capacity_)               { Buf.reserve(capacity_); Map.Data.reserve(capacity_); }
...
namespace ImGui
{
    ...
    IMGUI_API void                  ClearWindowSettings(const char* name_);
...
//#endif
    ...
    IMGUI_API bool          BeginChildEx(const char* name_, ImGuiID id, const ImVec2& size_arg, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags);
    ...
    // Menus
    IMGUI_API bool          BeginViewportSideBar(const char* name_, ImGuiViewport* viewport, ImGuiDir dir, float size, ImGuiWindowFlags window_flags);
    ...
    IMGUI_API bool          BeginTableEx(const char* name_, ImGuiID id, int columns_count, ImGuiTableFlags flags = 0, const ImVec2& outer_size = ImVec2(0, 0), float inner_width = 0.0f);
