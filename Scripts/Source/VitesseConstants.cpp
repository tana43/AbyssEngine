...
const VitesseConstants::Thruster VitesseConstants::Thrusters[static_cast<int>(Thruster::Location::Installed_Units)] =
{
	...
	//{"rig_J_upleg_L",				{-0.45f,0.1f,-0.015f},	{-138.0f,90.0f,64.0f},	{0.24f,0.25f,0.25f}},//BackLeg_R_U,//右膝裏あたり
	//{"rig_J_upleg_R",				{0.45f,-0.1f,0.015f},	{48.0f,90.0f,-64.0f},	{0.24f,0.25f,0.25f}},//BackLeg_L_U,//左膝裏あたり
	//{"rig_J_lowleg_L",				{-0.45f,-0.2f,0.01f},	{35.0f,-90.0f,0.0f},	{0.15f,0.06f,0.1f}},//BackLeg_R_M,//右ふくらはぎ中間
	//{"rig_J_lowleg_L",				{-0.65f,-0.2f,0.0f},	{35.0f,-90.0f,0.0f},	{0.15f,0.06f,0.1f}},//BackLeg_R_D,//右ふくらはぎ下側
	//{"rig_J_lowleg_R",				{0.45f,0.2f,0.0f},	{-145.0f,-90.0f,0.0f},	{0.15f,0.06f,0.1f}},//BackLeg_L_M,//左ふくらはぎ中間
	//{"rig_J_lowleg_R",				{0.65f,0.2f,0.0f},	{-145.0f,-90.0f,0.0f},	{0.15f,0.06f,0.1f}},//BackLeg_L_D,//左ふくらはぎ下側
	...
	//ソケット名						
	{"rig_robo_J_backpack_end_L",	},//BackPack_R_U,//バックパック右上
	{"rig_robo_J_backpack_end_L",	},//BackPack_R_D,//バックパック右下
	{"rig_robo_J_backpack_end_R",	},//BackPack_L_U,//バックパック右上
	{"rig_robo_J_backpack_end_R",	},//BackPack_L_D,//バックパック右下
	{"rig_J_upleg_L",				},//BackLeg_R_U,//右膝裏あたり
	{"rig_J_upleg_R",				},//BackLeg_L_U,//左膝裏あたり
	{"rig_J_lowleg_L",				},//BackLeg_R_M,//右ふくらはぎ中間
	{"rig_J_lowleg_L",				},//BackLeg_R_D,//右ふくらはぎ下側
	{"rig_J_lowleg_R",				},//BackLeg_L_M,//左ふくらはぎ中間
	{"rig_J_lowleg_R",				},//BackLeg_L_D,//左ふくらはぎ下側
	{"rig_J_upleg_L",				},//Waist_R,//腰右側
	{"rig_J_upleg_R",				},//Waist_L,//腰左側
	{"rig_J_lowleg_L",				},//Knee_R_R,//右膝、右側
	{"rig_J_lowleg_L",				},//Knee_R_L,//右膝、左側
	{"rig_J_lowleg_R",				},//Knee_L_R,//左膝、右側
	{"rig_J_lowleg_R",				},//Knee_L_L,//左膝、左側
	{"rig_sub02J_shoulder_L",		},//Shoulder_R_1,//右肩1番一番上のバーニアから時計回りに1,2,3番
	//{"rig_sub02J_shoulder_L",		},//Shoulder_R_2,//右肩2番一番上のバーニアから時計回りに1,2,3番
	//{"rig_sub02J_shoulder_L",		},//Shoulder_R_3,//右肩3番一番上のバーニアから時計回りに1,2,3番
	{"rig_sub02J_shoulder_R",		},//Shoulder_L_1,//左肩1番一番上のバーニアから時計回りに1,2,3番
	//{"rig_sub02J_shoulder_R",		},//Shoulder_L_2,//左肩2番一番上のバーニアから時計回りに1,2,3番
	//{"rig_sub02J_shoulder_R",		},//Shoulder_L_3,//左肩3番一番上のバーニアから時計回りに1,2,3番
	{"rig_J_upbody01",				},//Chest_R,//胸部右側
	{"rig_J_upbody01",				},//Chest_L,//胸部左側
};
