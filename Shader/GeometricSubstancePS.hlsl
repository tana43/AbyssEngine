...
float4 main(VS_OUT pin, bool is_front_face : SV_ISFRONTFACE) : SV_TARGET
{
    ...
    return PhysicallyBasedRendering(materialInfo, L, V, N, P, Li, primitiveData.transform, sceneData.viewProjection, primitiveData.emissiveIntensity, primitiveData.imageBasedLightingIntensity,primitiveData.minAmbient) * primitiveData.color;
}
