...
#if 0
	// Hard shadows
	shadowFactor = shadowMap.SampleCmpLevelZero(comparisonSamplerState, float3(positionLightSpace.xy, cascadeIndex), positionLightSpace.z - effectData.shadow_depth_bias).x;
#else
	// Soft shadows
